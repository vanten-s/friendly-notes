...
while not pr.window_should_close():
   ...
   # super cursed code, but it works
   # if you're reading this, please don't judge me // these two messages were generated by co-pilot
   # disable this 
    old_packet = packet
    ...
    if (packet != old_packet):
        ...
        s.close()
   # to this, if you're experincing problems
